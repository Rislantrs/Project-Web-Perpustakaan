        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
            ...
            >
              ...
              <img src={heroImg} alt="Gedung Kantor Arsip Purwakarta" className="relative rounded-2xl shadow-xl w-full object-cover aspect-[4/3]" />
            </motion.div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col-reverse lg:flex-row items-center gap-12 lg:gap-20">
            <motion.div
              ...
              className="lg:w-1/2"
            >
              <img src={depoImg} alt="Fasilitas Depo Arsip" className="rounded-2xl shadow-lg w-full object-cover aspect-[4/3]" />
            </motion.div>
            <motion.div
              initial={{ opacity: 0, x: 30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }}
              className="lg:w-1/2"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
            ...
            <motion.div
              ...
              className="lg:w-1/2 relative"
            >
              <img src={aaiImg} alt="Pelantikan Asosiasi Arsiparis" className="relative rounded-2xl shadow-xl w-full object-cover aspect-video" />
            </motion.div>
          </div>
        </div>
      </section>
