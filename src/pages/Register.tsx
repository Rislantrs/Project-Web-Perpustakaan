...
import { registerWithSupabase, loginWithGoogle } from '../services/supabaseAuthService';
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="relative my-4">
              ...
              <div className="relative flex justify-center text-xs uppercase">
                <span className="bg-white px-2 text-gray-500 font-semibold">Atau daftar dengan</span>
              </div>
            </div>
