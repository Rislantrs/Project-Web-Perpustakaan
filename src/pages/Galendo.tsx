...
export default function Galendo() {
  const googleFormUrl = SITE_CONFIG.EXTERNAL_LINKS.FORM_GALENDO;
        ...
        <div className="space-y-24">
          ...
          <div className="flex flex-col md:flex-row items-center gap-12">
            ...
            <div className="w-full md:w-1/2">
              <h3 className="font-serif text-3xl font-bold text-brand-primary mb-6">Pelestarian Naskah</h3>
          ...
          <div className="flex flex-col md:flex-row-reverse items-center gap-12">
            ...
            <div className="w-full md:w-1/2">
              <h3 className="font-serif text-3xl font-bold text-brand-primary mb-6">Manfaat GALENDO</h3>
          ...
          <div className="flex flex-col md:flex-row items-center gap-12">
            ...
            <div className="w-full md:w-1/2">
              <h3 className="font-serif text-3xl font-bold text-brand-primary mb-6">Alur Kegiatan</h3>
              <ul className="text-gray-600 leading-relaxed space-y-4 list-disc pl-5">
                ...
                <li>Mendaftarkan Naskah Kuno yang dimiliki oleh masyarakat ke Perpustakaan Nasional RI melalui Website <a href={SITE_CONFIG.EXTERNAL_LINKS.PERPUSNAS_PERNASKAHAN} target="_blank" className="text-brand-accent font-bold">pernaskahan.perpusnas.go.id</a></li>
          ...
          <div className="flex flex-col lg:flex-row items-center gap-16">
            ...
            <div className="w-full lg:w-1/2 text-white">
              ...
              <div className="space-y-8 pl-8">
                <div>
                  <h3 className="text-brand-accent font-bold text-xl mb-3">Manuskrip Perang Cina di Tanjung Pura</h3>
                ...
                <div className="pt-4 text-xs">
                  ...
                  <p className="text-brand-accent">Bidang Pengembangan dan Pelestarian Perpustakaan</p>
                </div>

                <div className="pt-6">
                  <a href={SITE_CONFIG.EXTERNAL_LINKS.PERPUSNAS_PERNASKAHAN} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 text-sm font-bold text-brand-accent hover:text-white transition-colors group">
            ...
            <div className="w-full lg:w-1/2 flex justify-center">
              <div className="relative w-full max-w-[420px] aspect-[3/4] max-h-[450px] md:max-h-none md:h-[650px] md:aspect-auto rounded-[30px] overflow-hidden flex items-center justify-center border border-white/5 bg-white/5 backdrop-blur-sm p-4">
                 ...
                 />
                 <div className="absolute top-6 right-6 bg-brand-accent text-brand-primary px-4 py-1.5 rounded-full text-[10px] font-black tracking-widest shadow-xl">
                    NASKAH ASLI
                 </div>
