  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <section className="relative min-h-[85vh] sm:min-h-[90vh] flex items-center bg-white overflow-hidden pt-28 pb-16 sm:py-20 lg:py-0">
        ...
        <div className="max-w-7xl 2xl:max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8 w-full relative z-20">
          ...
          >
            ...
            <div className="h-[140px] sm:h-[180px] mb-6 flex items-center overflow-visible">
              <AnimatePresence mode="wait">
                {!isSundanese ? (
                  <motion.h1
                    key="ind"
                    ...
                    className="font-serif text-3xl sm:text-5xl lg:text-6xl font-bold text-brand-primary leading-tight"
                  >
                  ...
                  <motion.h1
                    ...
                    initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }}
                    transition={{ duration: 0.4 }}
                    className="sundanese-text text-3xl sm:text-5xl lg:text-5xl xl:text-6xl font-bold text-brand-accent leading-normal pb-2 mt-4"
                  >
        ...
        <div className="max-w-7xl 2xl:max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-end mb-6 sm:mb-10">
            <div>
              ...
              <h2 className="font-serif text-2xl sm:text-4xl font-bold text-[#0c2f3d]">Berita Terkini</h2>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                    ...
                    <Link to={`/artikel/${news[activeNewsIdx].slug}`} className="block h-full relative overflow-hidden bg-brand-primary">
                      ...
                      <div className="absolute bottom-0 left-0 p-4 sm:p-8 w-full z-10">
                        <div className="flex items-center gap-3 mb-4">
                          ...
                          <span className="text-gray-300 text-xs sm:text-sm font-medium">{news[activeNewsIdx].date}</span>
                        </div>
                          <h3 className="text-lg sm:text-3xl font-bold text-white mb-2 sm:mb-4 group-hover:text-brand-accent transition-colors leading-tight line-clamp-2">
            ...
            <div className="lg:col-span-5 flex flex-col gap-3 sm:gap-4 lg:h-[500px]">
              {news.length > 0 ? (
      ...
      <section className="py-12 sm:py-24 bg-[#fcfafc] border-t border-gray-100">
        <div className="max-w-7xl 2xl:max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="font-serif text-2xl sm:text-4xl font-bold text-[#0c2f3d] mb-4">Akses Langsung Layanan Kami</h2>
      ...
      <section className="py-12 sm:py-24 bg-[#fcfafc] border-t border-gray-100">
        <div className="max-w-7xl 2xl:max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="font-serif text-xl sm:text-3xl font-bold text-[#0c2f3d]">Jelajah Literasi & Arsip Digital Terpadu</h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
            ...
            <div className="relative group rounded-3xl overflow-hidden shadow-2xl h-[260px] sm:h-[400px]">
              ...
              <div className="absolute inset-0 p-5 sm:p-10 flex flex-col justify-end">
                ...
                <h3 className="font-serif text-xl sm:text-3xl font-bold text-white mb-2 sm:mb-3">Pameran Virtual 360°</h3>
                <p className="text-gray-200 mb-4 sm:mb-8 max-w-md line-clamp-2 sm:line-clamp-3 text-sm sm:text-base">
            ...
            <div className="relative group rounded-3xl overflow-hidden shadow-2xl h-[260px] sm:h-[400px]">
              ...
              <div className="absolute inset-0 p-5 sm:p-10 flex flex-col justify-end">
                ...
                <h3 className="font-serif text-xl sm:text-3xl font-bold text-white mb-2 sm:mb-3">Simpul Jaringan SIKN & JIKN</h3>
                <p className="text-gray-200 mb-4 sm:mb-8 max-w-md line-clamp-2 sm:line-clamp-3 text-sm sm:text-base">
