...
const purwakartaSegments = [
  ...
  },
  {
    ...
    img: 'https://images.unsplash.com/photo-1588668214407-6ea9a6d8c272?auto=format&fit=crop&q=80&w=400'
  },
  {
    title: 'Bale Prabu Nigratwangi',
    desc: 'Menyajikan Purwakarta pada masa Hindia Belanda tahun 1800 – 1942.',
    img: 'https://images.unsplash.com/photo-1604928141064-207cea6f5722?auto=format&fit=crop&q=80&w=400'
  },
  {
    ...
    img: 'https://images.unsplash.com/photo-1590089415225-401cf6f9cd12?auto=format&fit=crop&q=80&w=400'
  },
  {
    ...
    img: 'https://images.unsplash.com/photo-1533158326339-7f3cf2404354?auto=format&fit=crop&q=80&w=400'
  },
  {
    title: 'Bale Prabu Nilakendra',
    desc: 'Menampilkan Purwakarta pada masa Demokrasi terpimpin 1959 – 1967.',
    img: 'https://images.unsplash.com/photo-1605806616949-1e87b487cb2a?auto=format&fit=crop&q=80&w=400'
  },
  {
    ...
    img: 'https://images.unsplash.com/photo-1578909196400-59f8f8156a05?auto=format&fit=crop&q=80&w=400'
  },
  {
    title: 'Bale Ki Pamanah Rasa',
    desc: 'Memberikan gambaran “Digjaya Purwakarta Istimewa“ 2008 – 2018.',
    img: 'https://images.unsplash.com/photo-1518998053401-b26431f496ed?auto=format&fit=crop&q=80&w=400'
  }
];
          ...
          {activeTab === 'purwakarta' ? (
            ...
            <div>
              ...
              <section className="px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto mb-24 text-center">
                 <div className="py-20 bg-gray-50 border border-gray-200 rounded-3xl border-dashed">
                    <p className="text-xl text-gray-500 font-medium">Informasi Segmen Diorama Nusantara sedang dikurasi.<br/>Segera Hadir.</p>
                 </div>
              </section>
            </div>
          )}
