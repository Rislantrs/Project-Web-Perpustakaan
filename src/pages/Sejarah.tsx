...
export default function Sejarah() {
  // Konten disusun statis untuk menjaga konsistensi narasi halaman.
  // Linimasa sejarah disusun statis di sisi frontend.
  // Jika ada revisi narasi resmi, perbarui array ini.
  const timelineData = [
    {
      period: "1992 – 1996",
          ...
          <div className="space-y-16">
            {timelineData.map((item, index) => (
              <div key={index} className="relative flex flex-col md:flex-row items-start md:justify-between group">
                ...
                {/* Posisi konten kiri atau kanan mengikuti indeks ganjil/genap */}
